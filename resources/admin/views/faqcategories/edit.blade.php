...
@section('content')
	<form name="form" method="POST" action="{{ route('admin.faqcategories.edit') }}" accept-charset="UTF-8" ng-controller="FAQCategoriesController" ng-submit="submit($event, form)" autocomplete="off" novalidate>
